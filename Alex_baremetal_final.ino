...
void setupSerial()
{
  ...
  // asynchronous mode, so bits 7 and 6 are 00
  // even parity, so bits 5 and 4 are 10
...
void startSerial()
{
  // UDRE, RXC interrupts, so bit 7, bit 5
  // disable TXCIE0
  // bits 4 and 3 must be 1 to eable receiver and transmitter
  // bit 2 must be 0 for 8 bit data size
  UCSR0B = 0b10111000;
